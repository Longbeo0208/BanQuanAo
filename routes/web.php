...
Route::get('/contact','App\Http\Controllers\HomeController@contact_layout');
...
Route::get('/chitietsanpham/{product_id}','App\Http\Controllers\ProductController@details_product');
...
Route::get('/product-new','App\Http\Controllers\ProductController@product_layout');
