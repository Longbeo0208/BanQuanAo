...
<div class="span9">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/1.png')}}"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/2.png')}}"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/3.png')}}"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/4.png')}}"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/5.png')}}"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="{{asset('public/frontend/images/6.png')}}"></a>
		</div>
	</div>
</section>
