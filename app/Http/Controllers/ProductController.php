...
class ProductController extends Controller
{
    ...
    public function details_product($product_id){
        ...
        $details_product = DB::table('tb_product')
        ->join('tb_category_product','tb_category_product.category_id','=','tb_product.category_id')
        ->join('tb_brand','tb_brand.brand_id','=','tb_product.brand_id')
        ...
        $related_product = DB::table('tb_product')
        ->join('tb_category_product','tb_category_product.category_id','=','tb_product.category_id')
        ->join('tb_brand','tb_brand.brand_id','=','tb_product.brand_id')
        ->where('tb_category_product.category_id',$category_id)->whereNotIn('tb_product.product_id',[$product_id])->get();
    ...
    public function product_layout(Request $request){
        $cate_product  = DB::table('tb_category_product')->where('category_status','0')->orderby('category_id','desc')->get();
        $brand_product = DB::table('tb_brand')->where('brand_status','0')->orderby('brand_id','desc')->get();
        ...
        return view('pages.sanpham.product_layout')->with('category',$cate_product)->with('brand',$brand_product)->with('all_product',$all_product);
