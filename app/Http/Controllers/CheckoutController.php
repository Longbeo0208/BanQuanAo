...
{   
    ...
    public function order_place(Request $request){
        ...
        $payment_id = DB::table('tb_payment')->insertGetId($data);
        ...
        foreach($content as $v_content){
            ...
            DB::table('tb_order_details')->insert($order_d_data);
        }
    ...
    public function login(Request $request){
        ...
        $result = DB::table('tb_customer')->where('customer_email',$email)->where('customer_password',$password)->first();
