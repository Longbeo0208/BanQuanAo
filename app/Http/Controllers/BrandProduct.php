...
class BrandProduct extends Controller
{
    ...
    public function save_brand_product(Request $request){
        ...
        Session::put('message','Thêm thượng hiệu thành công');
        return Redirect::to('/add-brand-product');
    }

    public function unactive_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tb_brand')->where('brand_id',$brand_product_id)->update(['brand_status'=>1]);
    ...
    public function active_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tb_brand')->where('brand_id',$brand_product_id)->update(['brand_status'=>0]);
    ...
    public function edit_brand_product($brand_product_id){
        $this->AuthLogin();
        $edit_brand_product = DB::table('tb_brand')->where('brand_id',$brand_product_id)->get(); 
    ...
    public function update_brand_product(Request $request,$brand_product_id){
        ...
        DB::table('tb_brand')->where('brand_id',$brand_product_id)-> update($data);
        Session::put('message','Cập nhật thương hiệu thành công');
        return Redirect::to('all-brand-product');
    }
    public function delete_brand_product($brand_product_id){
        $this->AuthLogin();
        DB::table('tb_brand')->where('brand_id',$brand_product_id)->delete();
    ...
    public function show_brand_home($brand_id){
        ...
        $brand_name = DB::table('tb_brand')->where('tb_brand.brand_id',$brand_id)->limit(1)->get();
