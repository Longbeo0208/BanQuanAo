...
class CategoryProduct extends Controller
{
    ...
    public function edit_category_product($category_product_id){
        $this->AuthLogin();
        $edit_category_product = DB::table('tb_category_product')->where('category_id',$category_product_id)->get(); 
    ...
    public function show_category_home($category_id){
        ...
        $category_name = DB::table('tb_category_product')->where('tb_category_product.category_id',$category_id)->limit(1)->get();
